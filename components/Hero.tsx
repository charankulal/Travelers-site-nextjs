    ...
    return (
        ...
        ">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                />
                <h1 className='bold-52 lg:bold-88'>Coorg Camp Area</h1>
            ...
            <div className="relative flex flex-1 items-start">
                <div className="relative z-20b w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-7">
                    <div className="flex flex-col">
                        <div className="flexBetween">
                            <p className='regular-16 text-gray-20'>Location</p>
                            <Image src='close.svg' alt='close' width={24} height={24} />
                        </div>
                        <p className='bold-20 text-white'>Raja Seat</p>
                    </div>
                    <div className="flexBetween">
                        <div className="flex flex-col">
                            <p className='regilar-16 block text-gray-20'>Distance</p>
                            <p className='bold-20 text-white'>173.28 mi</p>
                        </div>
                        <div className="flex flex-col">
                            <p className='regilar-16 block text-gray-20'>Elevation</p>
                            <p className='bold-20 text-white'>2.40 mi</p>
                        </div>
                    </div>
                </div>
            </div>
